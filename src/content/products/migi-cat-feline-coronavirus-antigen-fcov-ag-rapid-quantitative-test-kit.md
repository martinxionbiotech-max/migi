...
whenToTest: "When active feline coronavirus shedding is suspected, especially in multi-cat households, catteries, or shelters, or when FCoV exposure status is being screened."
whyTest: "Quantitative FCoV antigen detection can support identification and monitoring of active viral shedding."
interpretation: "Interpret the quantitative result with the kit IFU, clinical signs, and exposure history; FCoV antigen detection does not by itself diagnose feline infectious peritonitis (FIP)."
limitations: "A negative result does not rule out infection, and FCoV antigen testing does not establish FIP; results must be interpreted with clinical signs and other diagnostics."
---
...
Standard Test
: Click "Standard Test," insert the Test Device into the meter holder immediately after adding the sample, and click "Start Test." Select the sample type "Rectal Swab." The meter will automatically count down and display the test result.
Quick Test
