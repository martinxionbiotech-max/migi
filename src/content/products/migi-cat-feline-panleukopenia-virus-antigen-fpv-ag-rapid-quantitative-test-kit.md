...
whenToTest: "When feline panleukopenia is suspected, especially in unvaccinated kittens, cats with acute gastrointestinal signs, or during outbreaks."
whyTest: "Quantitative FPV antigen detection can support rapid confirmation and monitoring of active infection."
...
limitations: "A negative result does not rule out FPV infection; vaccination history and timing can affect interpretation, and results require clinical correlation."
---
...
Insert the swab into the feline's rectum and rotate it against the inner wall 3–5 times to collect a sample (approximately 1/2 to 2/3 of the cotton tip).
...
Test Mode Options:
a) Standard Test:
Select "Standard Test," insert the Test Device into the meter holder immediately after adding the sample, and click "Start Test." Choose the sample type "Rectal Swab." The meter will automatically read the result after counting down.
b) Quick Test:
