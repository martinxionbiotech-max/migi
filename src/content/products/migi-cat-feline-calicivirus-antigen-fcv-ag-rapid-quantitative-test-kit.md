...
whenToTest: "When a cat presents with compatible upper respiratory signs, oral ulceration, or fever, or during outbreak screening in multi-cat environments."
whyTest: "Quantitative FCV antigen detection can support early confirmation and monitoring of active feline calicivirus infection."
interpretation: "Compare the quantitative result with the kit IFU, clinical signs, and exposure history; suspected, weak, or strong positive categories should be interpreted in the full clinical picture."
limitations: "A negative result does not rule out FCV infection, and quantitative results must be interpreted with clinical signs and other diagnostics."
---
