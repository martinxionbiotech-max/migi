---
title: "Migi (Dog) Canine Cortisol (cCortisol) Rapid Quantitative Test Kit"
slug: "migi-dog-canine-cortisol-ccortisol-rapid-quantitative-test-kit"
description: "Migi (Dog) Canine Cortisol (cCortisol) Rapid Quantitative Test Kit — a quantitative fluorescence immunochromatography (FICT) rapid test for canine diagnostics, delivering results in minutes with pg/ml-level sensitivity. CE/ISO9001-compliant manufacturer. Cat. No. MG-CA-R018."
...
whenToTest: "When hyperadrenocorticism or hypoadrenocorticism is suspected based on compatible clinical signs, or as part of an endocrine work-up."
whyTest: "Canine cortisol measurement supports screening and monitoring for Cushing's syndrome and Addison's disease."
interpretation: "Use with the kit IFU, dynamic testing protocols where indicated, and clinical signs; a single basal cortisol is rarely sufficient for diagnosis."
limitations: "Quantitative cortisol results require clinical context and appropriate dynamic testing for definitive interpretation."
---
...
Choose test mode:
Standard Test
: Insert the Test Device into the analyzer immediately and click "Start Test". Select "Serum/Plasma". The analyzer will automatically provide results.
Quick Test
...
ACTH Before Use (nmol/L)
Suggestion
ACTH After Use (nmol/L)
Suggestion
< 55
