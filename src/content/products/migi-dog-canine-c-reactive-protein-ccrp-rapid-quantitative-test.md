...
a)
Standard Test:
Select “Standard Test”, insert the Test Device into the analyzer, and select the sample type (“Whole Blood” or “Serum/Plasma”). The analyzer will start automatically.
b)
Quick Test:
Select “Quick Test”, start the timer after adding the sample, and let the Test Device sit at room temperature for 3 minutes. Insert the Test Device into the analyzer and select the sample type.
...
Reference range:
≤10 mg/L: Normal (-)
10–30 mg/L: Mild inflammation (+)
30–100 mg/L: Moderate inflammation (++)
100 mg/L: Severe inflammation (+++)
