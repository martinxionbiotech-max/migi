...
1. Pull **your actual monthly volume** for the specific tests you'll run — from your billing history, not your ambition.
2. Get the **real cartridge cost** and shelf life from the vendor, in writing.
3. Estimate **overhead per test** (QC, maintenance, training, wastage ÷ annual volume).
4. Compute **margin per test** and **monthly margin**.
5. Divide **hardware cost** by monthly margin.
