---
title: "Parvo Testing in Dogs: Speed, Sensitivity and Outbreak Control"
slug: "canine-parvovirus-testing-guide"
description: "Parvo kills 91% of untreated puppies but 90% survive with fast treatment — so the test that returns a number in minutes is the difference. Here's antigen vs antibody, the 5–15 day vaccine false-positive window, and why pairing CPV antigen with CRP changes prognosis."
pubDate: "2026-09-05"
category: "blog"
faq: [{"q": "How is parvovirus detected in dogs?", "a": "By antigen testing on a faecal or rectal swab, which detects virus shed in stool. It can read positive within 3–7 days of exposure. Antibody testing on blood answers a different question — whether the dog has immunity from vaccination or prior exposure, not whether it is actively infected."}, {"q": "Can a parvo test be a false positive after vaccination?", "a": "Yes, and it is the most common cause of a positive in a healthy dog. A modified-live (MLV) vaccine can shed vaccine virus in stool for roughly 5–15 days after administration, and antigen tests cannot tell vaccine virus from wild virus. Always check vaccination history before acting on a positive."}, {"q": "How fast can a parvo test return a result?", "a": "Quantitative fluorescence antigen tests return a result in about 3–11 minutes on an analyzer like the FIA680 or FIA880, versus sending a sample to an outside lab which can cost a day or more. In parvo, a day is a material difference to survival."}, {"q": "Why does a quantitative number matter for parvo?", "a": "Viral load correlates with severity and prognosis. Puppies around 14 weeks carry the highest viral loads, and tracking whether the antigen number falls after 48 hours of treatment tells you if the dog is responding. A simple positive/negative line gives you none of that."}, {"q": "What role does CRP play in parvo monitoring?", "a": "CRP is the follow-up number. In parvo patients, CRP above ~92.4 mg/L predicts roughly 91% of deaths, and if it stays above 150 mg/L survival drops below 15%. Pairing a CPV antigen test with a CRP test on the same analyzer gives you both the diagnosis and the prognosis."}]
---
...
1. **Always check vaccination history before acting on a positive.** Vaccinated in the last 5–15 days? A positive needs a second look, not an automatic quarantine.
2. **A positive in a dog showing classic signs** — bloody diarrhoea, vomiting, lethargy, fever — is parvo until proven otherwise. Don't let the vaccine window delay treatment of a genuinely sick dog.
3. **When it's ambiguous, re-test 24–48 hours later** and read the *trend* — which is exactly where a quantitative number beats a yes/no line.
...
1. **Screen at intake.** Antigen-test every new dog before it enters shared space. A 3–11 minute result means you can isolate *before* the first shared kennel run, not after.
2. **Test any dog with vomiting or diarrhoea immediately.** Don't "watch and wait" — by the time signs are obvious, the dog has been shedding for days.
3. **On a positive, isolate and disinfect.** Bleach (diluted 1:30) or accelerated hydrogen peroxide on every surface the dog touched. Skip the generic disinfectants — parvo shrugs them off.
4. **Re-test the symptomatic population in 24–48 hours**, reading the trend, not just the result.
5. **Check immunity separately.** Antibody-test the recovered and the vaccinated to confirm protection before they rejoin the group.
