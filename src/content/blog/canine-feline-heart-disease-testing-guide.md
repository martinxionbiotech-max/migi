---
title: "Canine & Feline Heart Disease Testing: Complete Guide"
slug: "canine-feline-heart-disease-testing-guide"
description: "Heart disease is the silent killer of older dogs and cats. MMVD hits 85% of small dogs by 13; HCM hits ~15% of cats. Here is the testing ladder."
pubDate: "2026-09-05"
author: "Dr. Tang"
dateModified: "2026-09-05"
category: "blog"
faq: [{"q": "What is the most common heart disease in dogs and cats?", "a": "In dogs it is myxomatous mitral valve disease (MMVD) — up to 85% of small-breed dogs show the valve lesion by 13 years of age. In cats it is hypertrophic cardiomyopathy (HCM), found in roughly 15% of random-bred cats. The two diseases need different testing strategies: dogs are screened by auscultation then NT-proBNP, cats by NT-proBNP first because their murmurs are less reliable."}, {"q": "Which test first — auscultation, X-ray, NT-proBNP or echo?", "a": "Follow the ladder: auscultation flags a murmur, thoracic X-ray screens for heart enlargement and fluid, NT-proBNP separates cardiac from respiratory signs with one blood draw, and echocardiography is the gold standard that characterizes the disease. NT-proBNP is the cheapest triage step that prevents sending every coughing dog to a cardiologist."}, {"q": "Can a normal NT-proBNP rule out heart disease?", "a": "Mostly, but not absolutely. In dogs a value above ~1158 pmol/L is 85.5% sensitive and 81.3% specific for congestive heart failure; in cats a cutoff of 265 pmol/L is 90% sensitive and 88% specific. A low value makes clinically significant heart disease unlikely, but early MMVD or HCM with minimal wall stress can still read normal — which is why at-risk breeds get serial testing, not one snapshot."}, {"q": "Does a heart murmur mean heart disease?", "a": "Not always, and the reverse is more dangerous: many cats with HCM have no murmur at all, and a soft early MMVD murmur can be missed on a rushed auscultation. A murmur is a reason to test, not a diagnosis. In cats especially, rely on NT-proBNP and echo rather than waiting for a loud murmur."}, {"q": "How fast is heart testing in-house?", "a": "NT-proBNP returns in 10–20 minutes on a quantitative immunofluorescence analyzer like the Migibio FIA680 or FIA880. Auscultation is instant, X-ray is minutes, and only echocardiography needs a specialist or a trained operator. The first three steps can happen entirely within one consult."}, {"q": "Why screen at-risk breeds if they look healthy?", "a": "Because the diseases are silent until decompensation. Cavaliers, Dachshunds and Chihuahuas for MMVD; Maine Coons and Ragdolls for HCM — these breeds develop disease years before clinical signs. A rising NT-proBNP trend across a year catches the disease while therapy is cheap and effective, not after the first bout of heart failure."}]
---
...
| | **Dogs** | **Cats** |
|---|---|---|
| Most common disease | MMVD (leaky mitral valve) | HCM (thickened heart muscle) |
| Second | DCM (dilated heart, large breeds) | RCM (restrictive, less common) |
| Typical patient | Small breeds >8 years | Any cat, often middle-aged |
| Best first signal | Heart murmur (usually audible) | NT-proBNP (murmurs unreliable) |
| Prevalence headline | 85% of small dogs by 13 years | ~15% of cats |
...
| Species | Cut-off | What it separates | Performance |
|---|---|---|---|
| Dog | ~201 pmol/L | Cardiac vs primary respiratory | — |
| Dog | ~1158 pmol/L | CHF vs non-cardiac dyspnea | 85.5% sens / 81.3% spec |
| Cat | ~265 pmol/L | CHF vs respiratory disease | 90% sens / 88% spec |
...
**Related products:** [Canine NT-proBNP Test](/reagents/migi-dog-canine-n-terminal-pro-brain-natriuretic-peptide-cnt-probnp-rapid-quantitative-test-kit) · [Feline NT-proBNP Test](/reagents/migi-cat-feline-n-terminal-pro-brain-natriuretic-peptide-fnt-probnp-rapid-quantitative-test-kit) · [FIA680 Analyzer](/equipment/FIA680) · [FIA880 Analyzer](/equipment/FIA880)
...
- [ACVIM — MMVD Consensus Guidelines](https://www.acvim.org/)
...
- [IRIS — Chronic Kidney Disease Staging](https://www.iris-kidney.com/)

## Continue exploring

- [NT-proBNP in Dogs and Cats: Heart vs Breathing Trouble](/blog/nt-probnp-testing-dogs-cats-heart-disease)
- [MMVD in Dogs: Testing Mitral Valve Disease](/blog/mmvd-testing-dogs-mitral-valve-disease)
- [HCM in Cats: Testing Hypertrophic Cardiomyopathy](/blog/hcm-testing-cats-hypertrophic-cardiomyopathy)
- [Heart Disease Screening in Dogs and Cats](/blog/heart-disease-screening-dogs-cats)
