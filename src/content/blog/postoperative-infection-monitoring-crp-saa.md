...
category: "blog"
faq: [{"q": "Why measure CRP or SAA after surgery?", "a": "Because surgery itself triggers an inflammatory response, and the acute-phase proteins track it. CRP (in dogs) and SAA (in cats) rise after surgery, peak at 24–48 hours, and should then fall steadily. A value that stays high or climbs again flags a complication — infection, dehiscence, or an abscess — often before it is clinically obvious."}, {"q": "What is the normal post-operative CRP/SAA pattern?", "a": "A rise beginning within hours of surgery, peaking at 24–48 hours, then a steady fall over the following days. The exact magnitude depends on the surgery's invasiveness, but the shape of the curve — up, peak, down — is the same. A deviation from that shape is the warning sign."}, {"q": "When should I suspect a post-op complication?", "a": "When the marker does not follow the expected curve: a CRP/SAA that remains elevated beyond 48–72 hours, fails to fall, or rises again after an initial decline. That pattern raises suspicion of surgical-site infection, dehiscence, or another inflammatory complication, and warrants investigation before clinical signs declare themselves."}, {"q": "Which marker should I use — CRP or SAA?", "a": "Follow the species split: CRP for dogs, SAA for cats. Dogs have a strong CRP response and cats a weak one; cats answer to SAA instead. Using the wrong marker for the species under-reads the inflammatory response."}, {"q": "Does the magnitude of the post-op rise predict complications?", "a": "Not reliably on its own — a big surgery legitimately produces a big rise. What matters is the trend after the peak. A high value that is falling on schedule is expected; a value that plateaus or climbs is the concern. The direction, not the absolute number, is the signal."}, {"q": "How often should I measure after surgery?", "a": "A practical protocol is a baseline before surgery, a measurement at 24–48 hours to catch the peak, then serial measurements (e.g. daily or every other day) in high-risk cases until the value trends down. Routine cases may only need a single 24–48 hour check to confirm the expected rise-and-fall."}]
---
...
| Phase | Timing | Marker behaviour |
|---|---|---|
| Onset | Hours after surgery | Begins to rise |
| Peak | 24–48 h | Maximum (proportional to invasiveness) |
| Resolution | Days 2–4 | Steady fall |
...
**Related products:** [Canine CRP Test](/reagents/migi-dog-canine-c-reactive-protein-ccrp-rapid-quantitative-test) · [Feline SAA Test](/reagents/migi-cat-fsaa-feline-serum-amyloid-a-rapid-quantitative-test) · [FIA680 Analyzer](/equipment/FIA680) · [FIA880 Analyzer](/equipment/FIA880)
...
- [PMC — Comparison of SAA and CRP](https://pmc.ncbi.nlm.nih.gov/articles/PMC3894877/)
- [PubMed — Canine CRP](https://pubmed.ncbi.nlm.nih.gov/)
