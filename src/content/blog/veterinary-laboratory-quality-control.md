---
title: "Veterinary Laboratory Quality Control: Two Pillars"
...
1. **Documented procedures** — written SOPs for every test.
2. **Internal controls** — run with every test, verified and recorded.
3. **External controls** — run on a defined schedule.
4. **Training** — initial and ongoing operator competency.
5. **Records** — lot numbers, QC results, and corrective actions, retained for traceability.
