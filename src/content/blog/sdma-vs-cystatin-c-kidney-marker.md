...
category: "blog"
faq: [{"q": "What is the difference between SDMA and cystatin C?", "a": "Both are early kidney markers that rise before creatinine and are independent of muscle mass. SDMA (0–14 µg/dL) has the stronger evidence base and is the IRIS staging standard; cystatin C (~0.5–1.2 mg/L dog, 0.6–1.8 mg/L cat) is an independent confirmatory marker whose reference interval is assay-dependent."}, {"q": "Why does creatinine miss early kidney disease?", "a": "Creatinine only rises after roughly 60–75% of kidney function is lost, and it is affected by muscle mass. SDMA and cystatin C both rise at only 25–40% loss and ignore muscle mass, so they catch decline a year or more earlier."}, {"q": "Is the 14 µg/dL SDMA cut-off reliable?", "a": "It is the IDEXX reference upper limit, but independent work (McKenna 2020) found 14 µg/dL produced false positives in about 50% of non-azotemic dogs, and that 18 µg/dL was more accurate (90% sensitivity, 83% specificity). This is why a persistent elevation — not one reading — should drive a CKD diagnosis."}, {"q": "What is the normal SDMA range for cats and dogs?", "a": "The IDEXX reference interval is 0–14 µg/dL for both. A persistent value above 14 µg/dL with a normal creatinine supports Stage 1 CKD, but borderline 15–17 µg/dL results should be rechecked rather than treated as definitive."}, {"q": "Can cystatin C replace creatinine?", "a": "Not as a standalone. Its reference interval is assay-dependent and it can be shifted by thyroid disease, steroids and inflammation. It works best as an independent confirmatory marker alongside SDMA rather than a replacement."}, {"q": "How much does early kidney screening help a clinic?", "a": "Early CKD caught at Stage 1 is managed with diet, blood-pressure control and monitoring — inexpensive, high-compliance care. The screening itself is a billable panel, and the patient becomes a long-term monitoring relationship rather than a late-stage emergency."}]
---
...
| Criterion | SDMA | Cystatin C |
|---|---|---|
| Evidence base | Strong, extensive | Moderate, growing |
...
| Confounders | Minimal | Thyroid, steroids, inflammation |
| Best role | First-line + staging | Confirmatory / second opinion |
...
| IRIS Stage | Dog Creatinine (mg/dL) | Cat Creatinine (mg/dL) | SDMA (µg/dL) |
|---|---|---|---|
| Stage 1 | <1.4 | <1.6 | <18 |
| Stage 2 | 1.4–2.8 | 1.6–2.8 | 18–35 |
| Stage 3 | 2.9–5.0 | 2.9–5.0 | 36–54 |
| Stage 4 | >5.0 | >5.0 | >54 |
...
|---|---|
| Routine senior screening | SDMA (with creatinine) |
| Suspicious/borderline SDMA (15–17) | Recheck serially; add cystatin C to confirm |
| Muscle-wasted patient | SDMA or cystatin C (not creatinine alone) |
| Monitoring diagnosed CKD | SDMA serially (IRIS staging) |
| Azotemic + multiple comorbidities | SDMA for staging, cystatin C as independent check |
| Pre-anesthesia / pre-nephrotoxic drug | SDMA |
...
**Related reading:** [Veterinary Biomarker Testing](/blog/veterinary-biomarker-monitoring-kidney-cardiac) · [What Is SDMA in Cats?](/blog/what-is-cats-sdma-how-to-diagnose-it-quickly) · [NT-proBNP Testing in Dogs and Cats](/blog/nt-probnp-testing-dogs-cats-heart-disease)
