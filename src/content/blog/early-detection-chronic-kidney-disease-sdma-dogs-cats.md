...
| Muscle-mass dependent? | Yes | **No** |
| Species | Both | **Both (0–14 µg/dL)** |
...
For the species-specific and marker-comparison detail, see the companion guides: [SDMA vs Cystatin C: which kidney marker to choose](/blog/sdma-vs-cystatin-c-kidney-marker) and [SDMA in cats: catching kidney disease before creatinine moves](/blog/what-is-cats-sdma-how-to-diagnose-it-quickly).

**Related product:** [SDMA Stage CKD Kit](/reagents/sdma-stage-chronic-kidney-disease-kit) — quantitative SDMA on the FIA680/FIA880.
