---
title: "FIP in Cats: What a Coronavirus Test Actually Tells You — and Why It Can't Diagnose FIP"
slug: "feline-coronavirus-fip-testing"
description: "A positive feline coronavirus test is not FIP — most infected cats never develop it. Here's the antibody-titre trap, the A:G ratio's false-positive problem, what actually diagnoses FIP, and how antiviral treatment changed the outlook."
pubDate: "2026-09-05"
category: "blog"
faq: [{"q": "Does a positive coronavirus test mean my cat has FIP?", "a": "No. Feline coronavirus (FCoV) is a common, usually mild gut infection, and the vast majority of infected cats never develop FIP. A positive FCoV antigen test confirms coronavirus infection only. FIP requires a clinical workup — compatible signs, effusion analysis and blood markers — not a single test."}, {"q": "Can an antibody titre diagnose FIP?", "a": "No, and it's a real trap. Many healthy cats carry high FCoV antibody titres, and about 10% of cats with confirmed FIP have no detectable antibodies at all. A single titre at one point in time is not diagnostic — high titres don't confirm FIP, and negative titres don't rule it out."}, {"q": "Is a low A:G ratio enough to diagnose FIP?", "a": "Not on its own. A:G below 0.6 is a classic FIP finding, but common conditions — including dental disease — can also push A:G below 0.6. A:G below 0.4 is highly suggestive and above 0.6 lowers the likelihood, but it must be read with clinical signs and other tests."}, {"q": "How is FIP actually diagnosed?", "a": "By combining clinical signs (persistent fever, weight loss, effusion), effusion analysis in the 'wet' form, blood markers (low A:G, high globulins), and ideally PCR on effusion or tissue. There is no single definitive blood test — it is a multimodal diagnosis."}, {"q": "Can FIP be treated?", "a": "Yes — this has changed completely. The antiviral GS-441524 (and oral remdesivir) now achieves survival rates near 80% in effusive FIP for cats that survive the first 48 hours of treatment. What was once a fatal disease is now, with prompt diagnosis, largely treatable."}, {"q": "What is the FCoV antigen test useful for?", "a": "Screening and outbreak management — identifying coronavirus shedders in multi-cat households, shelters and catteries to guide hygiene and isolation. It is a screening and epidemiological tool, not a standalone FIP diagnostic."}]
---

# FIP in Cats: What a Coronavirus Test Actually Tells You — and Why It Can't Diagnose FIP
...
**Related product:** [FCoV-Ag Feline Coronavirus Antigen Test](/reagents/migi-cat-feline-coronavirus-antigen-fcov-ag-rapid-quantitative-test-kit) — a quantitative antigen test (cat. MG-CA-R029, 10-test box, room-temperature storage) that reports viral load rather than a yes/no line.
