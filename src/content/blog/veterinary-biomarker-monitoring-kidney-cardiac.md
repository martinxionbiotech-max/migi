---
title: "Veterinary Biomarker Testing: The Complete Guide to Monitoring Organ Health in Dogs and Cats"
...
category: "blog"
faq: [{"q": "What is a veterinary biomarker?", "a": "A biomarker is a measurable substance in blood whose concentration reflects a specific organ or process. Examples include SDMA and cystatin C for kidney function, NT-proBNP for cardiac stress, pancreatic lipase for pancreatitis, CRP/SAA for inflammation, and thyroid hormones for endocrine status."}, {"q": "Why is quantitative biomarker testing better than qualitative?", "a": "Quantitative results give a number with units, not just positive/negative. That number can be compared against a reference range, tracked over time as a trend, and used to stage disease (such as IRIS CKD staging by SDMA). Trends reveal whether a patient is improving or deteriorating before clinical signs change."}, {"q": "Which biomarkers should I monitor in a senior pet?", "a": "For senior dogs and cats, the core panel is SDMA (kidney), NT-proBNP (heart), and T4/TSH (thyroid), plus CRP or SAA if inflammation is suspected. These detect the most common age-related diseases — chronic kidney disease, heart disease, and hyperthyroidism — often before signs appear."}, {"q": "How often should biomarkers be monitored?", "a": "Kidney and cardiac biomarkers are typically checked every 3–6 months in chronic disease, inflammation markers during and after treatment, and thyroid hormones 4–6 weeks after starting medication. Serial trends matter more than any single value."}, {"q": "What is the difference between SDMA and creatinine?", "a": "SDMA rises when only about 25–40% of kidney function is lost, whereas creatinine does not increase until roughly 60–75% is gone. SDMA is also independent of muscle mass, so it stays accurate in cachectic or geriatric patients where creatinine is unreliable."}, {"q": "Can a single blood sample screen multiple organs?", "a": "Yes. One serum or plasma sample can be split across several quantitative assays on an immunofluorescence analyzer — SDMA for kidney, NT-proBNP for heart, T4/TSH for thyroid, and CRP/SAA for inflammation — giving a multi-organ snapshot from one draw."}, {"q": "Does hemolysis affect biomarker results?", "a": "Hemolysis can interfere with fluorescence-based immunoassays and alter some biomarker values, so visibly hemolyzed samples should be recollected when possible. Lipemia and icterus can also interfere, which is why proper sample handling is part of accurate quantitative testing."}, {"q": "Can I run these biomarker tests on the Migibio FIA680 or FIA880?", "a": "Yes. The Migibio FIA680 and FIA880 immunofluorescence analyzers run quantitative biomarker panels including SDMA, cystatin C, NT-proBNP, cPL/fPL, CRP/SAA, cortisol, and thyroid hormones, returning numeric results in about 10–20 minutes from serum or plasma."}]
---

# Veterinary Biomarker Testing: The Complete Guide to Monitoring Organ Health in Dogs and Cats
...
| Organ / System | Biomarker | Species | Normal Range | Flags Disease When |
|---|---|---|---|---|
| Kidney | SDMA | Dog & Cat | 0–14 µg/dL | >14 (persistent), >18 = CKD |
| Kidney | Cystatin C | Dog / Cat | 0.5–1.2 / 0.6–1.8 mg/L | Above reference (assay-dependent) |
| Heart | NT-proBNP | Dog | <900 pmol/L | >900 (grey zone 900–1800) |
| Heart | NT-proBNP | Cat | <100 pmol/L | >270 (grey zone 100–270) |
| Pancreas | cPL | Dog | <200 µg/L | >400 (equivocal 200–400) |
| Pancreas | fPL | Cat | ≤3.5 µg/L | ≥5.4 (equivocal 3.6–5.3) |
| Inflammation | CRP | Dog | <10 mg/L | >35 (low-grade 10–35) |
| Inflammation | SAA | Cat | <10 µg/mL | >10 (severe >100) |
| Endocrine | Cortisol | Dog | 2–6 µg/dL basal | >22 post-ACTH (Cushing's) |
| Endocrine | Total T4 | Dog / Cat | 1.0–4.0 / 0.8–4.0 µg/dL | <1.0 (hypo) / >4.0 (hyper) |
| Endocrine | TSH | Dog | <0.6 ng/mL | Elevated + low T4 = hypothyroid |
...
In practice, SDMA and cystatin C are complementary. SDMA has the stronger published evidence base and is the standard for IRIS staging; cystatin C is a useful independent confirmatory marker. For a full comparison, see [SDMA vs. Cystatin C: Which Kidney Marker to Choose](/blog/sdma-vs-cystatin-c-kidney-marker).
...
| IRIS Stage | Dog Creatinine (mg/dL) | Cat Creatinine (mg/dL) | SDMA (µg/dL) | Interpretation |
|---|---|---|---|---|
| Stage 1 | <1.4 | <1.6 | <18 | Non-azotemic; other abnormality present |
| Stage 2 | 1.4–2.8 | 1.6–2.8 | 18–35 | Mild renal azotemia |
| Stage 3 | 2.9–5.0 | 2.9–5.0 | 36–54 | Moderate renal azotemia |
| Stage 4 | >5.0 | >5.0 | >54 | Severe renal azotemia |
...
**Related products:** [SDMA CKD Kit](/reagents/sdma-stage-chronic-kidney-disease-kit) · [Canine Cystatin C Test](/reagents/migi-dog-canine-cystatin-c-ccys-c-rapid-quantitative-test-kit) · [Feline Cystatin C Test](/reagents/migi-cat-feline-cystatin-c-fcys-c-rapid-quantitative-test-kit)
...
The full clinical picture is in [NT-proBNP Testing in Dogs and Cats: Detecting Heart Disease Early](/blog/nt-probnp-testing-dogs-cats-heart-disease).
...
For everything from sample handling to interpreting grey-zone results, see [Canine cPL and Feline fPL: Diagnosing Pancreatitis with Confidence](/blog/canine-cpl-feline-fpl-pancreatitis-testing).

**Related products:** [Canine Pancreatic Lipase Test](/reagents/migi-dog-canine-pancreatic-lipase-cpl-rapid-quantitative-test-kit) · [Feline Pancreatic Lipase Test](/reagents/migi-cat-feline-pancreatic-lipase-fpl-rapid-quantitative-test-kit)
...
Neither marker identifies the *cause* of inflammation. They tell you *how much* inflammation is present and *whether it's responding*. That's a different, and often more actionable, question. Details in [CRP and SAA: Grading Inflammation in Dogs and Cats](/blog/canine-crp-feline-saa-inflammation-testing).
...
The full interpretive guide is [Thyroid Testing in Dogs and Cats: T4 and TSH Explained](/blog/feline-tt4-tsh-thyroid-testing).
...
The complete protocols are in [Cortisol Testing in Dogs: Diagnosing Cushing's and Addison's Disease](/blog/cortisol-testing-dogs-cushings-addisons).

**Related products:** [Canine T4 Test](/reagents/migi-dog-canine-total-thyroxine-ctt4-rapid-quantitative-test-kit) · [Canine TSH Test](/reagents/migi-dog-canine-thyroid-stimulating-hormone-ctsh-rapid-quantitative-test-kit) · [Feline T4 Test](/reagents/migi-cat-feline-total-thyroxine-ftt4-rapid-quantitative-test-kit) · [Canine Cortisol Test](/reagents/migi-dog-canine-cortisol-ccortisol-rapid-quantitative-test-kit)
...
For more on the underlying technology, see [What Is Fluorescence Immunochromatography (FICA)?](/blog/what-is-fluorescence-immunochromatography-fica) and [How to Choose a Veterinary Immunofluorescence Analyzer](/blog/how-to-choose-a-veterinary-immunofluorescence-analyzer).
...
2. **Quantitative numbers** enable IRIS staging, grey-zone interpretation, and serial trend tracking that qualitative tests can't support.
3. SDMA and cystatin C are the kidney early-warning pair; NT-proBNP is the cardiac triage tool; cPL/fPL confirm pancreatitis; CRP/SAA grade inflammation; T4/TSH and cortisol map the endocrine system.
4. **One sample, multiple assays** — a single draw can screen kidney, heart, thyroid, and inflammation together.
5. The trend is the diagnosis. Serial values reveal progression and treatment response before clinical signs change.
