...
Migibio is a POCT veterinary diagnostics manufacturer offering OEM, ODM, and private-label services across the diagnostic workflow — from reagent research and development to analyzer production and quality control. This page describes the capabilities documented in the company's archived product and corporate pages; it is a capability overview, not a list of performance claims or customer references.

## Manufacturing capabilities

The following capabilities are supported by Migibio's published product attributes and corporate pages:
...
This page intentionally does not list customer names, order volumes, export figures, or qualifications that are not present in the archived source pages. For certificate scope and current documentation, contact the sales team.

## OEM / ODM / private label

Migibio supports three related partnership models:

- **Private label** — custom packaging, labeling, and formulation for distributors and brands, as described in the contact FAQ.
- **ODM** — rebranding an existing analyzer and reagent line under a partner's brand, including packaging, manuals, IFU language, and software interface localization.
- **OEM** — building to a partner's specification, such as a custom reagent menu or analyzer modification, with validation and regulatory requirements scoped per project.

Analyzer customization is supported by the published FIA680/FIA880 attributes: language options include Chinese, English, Russian, and Italian, and cloud-chip technology enables custom standard curves, custom reference ranges, online software updates, and recovery of lost ID chips over Wi-Fi. Specific timelines, minimum order quantities, and regulatory responsibilities depend on the customization scope and target market; contact Migibio to scope the project.
...
- [Research & Analytical Performance](/research/)
- [About Migibio](/about/)
- [Corporate Identity](/corporate-identity/)
- [FIA680 Analyzer](/equipment/FIA680/)
- [FIA880 Analyzer](/equipment/FIA880/)
- [Canine & Feline Reagents](/reagents/)

## Request OEM/ODM information

To scope an OEM, ODM, or private-label project, include the target market, analyte menu, analyzer preference, packaging/language requirements, and estimated quantity in your inquiry:

- **Email:** [martinwang2024@gmail.com](mailto:martinwang2024@gmail.com)
